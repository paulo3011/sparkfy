...
insert2 = """
insert into artist_history (user_id, session_id, artist, song, item_in_session, first_name, last_name)
...
query3 = "select first_name, last_name from user_history where song='All Hands Against His Own'"
...
insert3 = "insert into user_history (first_name, last_name, song) VALUES (%s,%s,%s)"
